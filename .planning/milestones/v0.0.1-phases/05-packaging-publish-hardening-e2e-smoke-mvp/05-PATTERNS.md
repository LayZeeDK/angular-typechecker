...
import type { EmitFlags, Program, UNKNOWN_ERROR_CODE }
  from '../../../../node_modules/@angular/compiler-cli/src/transformers/api';
// eslint-disable-next-line @nx/enforce-module-boundaries -- documented nodenext deep-import workaround
import type { defaultGatherDiagnostics, formatDiagnostics, ParsedConfiguration, performCompilation, readConfiguration }
...
```typescript
interface RunResult { stdout: string; code: number; }
