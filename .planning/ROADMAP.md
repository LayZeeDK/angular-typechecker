...
- [ ] 21-03-PLAN.md -- ACB-01/ACB-03 in-repo guard suite: builder schema-parity, thin-wrapper structural parity, and the `executors ?? builders` Nx-surface regression
