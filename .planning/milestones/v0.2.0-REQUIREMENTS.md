# Requirements Archive: v0.2.0 Storybook story type-checking
...
# Requirements: v0.2.0 -- Storybook story type-checking

**Milestone:** v0.2.0 (minor release; a breaking change to the programmatic `CoreResult` API bumps
the minor under 0.x -> `0.1.1 -> 0.2.0`).
...
- [x] **SB-09**: Vite/Analog Storybook query-import guidance (follow-up from the Phase-19 OSS UAT +
  ...
  (IN SCOPE for Phase 20 -- both signals committed to v0.2.0, 2026-07-07):** a verdict-neutral
