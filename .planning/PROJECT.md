...
- **Current milestone:** v0.1.2 (Storybook story type-checking) -- IN PROGRESS. Scope + decisions hardened by a 6-lens Opus advisory board (`.planning/research/v0.1.2-storybook/board/CONSENSUS.md`); requirements SB-01..08 in `.planning/REQUIREMENTS.md`; phases 16-19 in `.planning/ROADMAP.md`. (v0.1.1 was a packaging hotfix that shipped built `.js`; no roadmap phases between 15 and 16.)
