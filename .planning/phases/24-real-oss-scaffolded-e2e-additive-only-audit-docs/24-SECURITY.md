...
threat is `mitigate` or `accept` and each mitigation was independently confirmed by the
Phase 24 code review (`24-REVIEW.md`) and goal verification (`24-VERIFICATION.md`).
