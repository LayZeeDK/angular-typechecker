...
*Status: ⬜ pending · ✅ green · ❌ red · ⚠️ flaky · ⚪ manual-only. All 12 automated rows RE-RUN LIVE this audit (2026-06-28) and PASSED. The two manual-only rows are B-01 publish-gated and excluded from the chain gate; the live publish (05-05) was nonetheless COMPLETED out-of-band.*
