...
| eslint.config.mjs | src/core/**/*.ts | files-scoped no-restricted-imports override | WIRED | `:16`; negative-control probe confirmed the rule fires (2 errors on a banned type-only import). |
