...
- [ ] 18-01-PLAN.md - D-01 net-new "not type-checked" advisory: pure detector + CoreResult field on walk + direct paths + executor render + green-verdict negative test [wave 1]
- [ ] 18-02-PLAN.md - Residual boundary-semantics integration: T9 (paths-alias, criterion 2), T6 (story-less guard), T5 (node_modules suppression), T10 (host-only-.storybook) [wave 1]

**Wave 2** *(blocked on Wave 1)*

- [ ] 18-03-PLAN.md - T11 integration proof: declared .mdx (+ JSX-free .tsx) fires the notice, verdict stays clean [wave 2]
- [ ] 18-04-PLAN.md - Packaged-tarball Storybook e2e (criterion 1): shipped artifact catches a planted story error on Layout A + B via nx add + nx g configuration + nx typecheck [wave 2]

**Wave 3** *(blocked on Wave 2)*

- [ ] 18-05-PLAN.md - Docs (SB-07): README ## Storybook coverage claim + Limitations WR-01 fix + CoreResult comment + curated CHANGELOG 0.1.2 green->red callout (prose only, no release cut) [wave 3]
...
| 18. Packaged-tarball e2e + docs | v0.1.2 | 0/5 | Planned | -- |
