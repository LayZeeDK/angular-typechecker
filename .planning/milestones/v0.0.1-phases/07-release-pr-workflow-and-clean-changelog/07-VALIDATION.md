...
*Status: [PENDING] pending - [GREEN] green - [RED] red - [FLAKY] flaky*
*Tier: repeatable (CI assertion) - one-time operational (live config, verified once) - live-PR proof (Phase-6 SC3-style) - code-review (AGENTS.md gate)*
